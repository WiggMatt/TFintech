    ...
    private static Stream<Object[]> provideCurrencyCodesForValidation() {
        return Stream.of(
                new Object[]{"INVALID_CODE",
                        new UnsupportedCurrencyException("Unsupported currency code"),
                        "Unsupported currency code: INVALID_CODE"},
                new Object[]{"XXX",
                        new CurrencyNotFoundException("Currency rate not found for code: XXX"),
